<div class="project-bar">
    ...
    <el-form class="form-container" :model="projectForm" :rules="rules" ref="projectForm">
        ...
        <div>
            <el-button @click="submitProject" type="primary">创建</el-button>
    ...
    new Vue({
        ...
        methods:{
            ...
            handleSuccess(response, file) {
                ...
                this.projectForm.image.push(file);
                // this.projectForm.image.push(response.data);
                return file;
            },
            ...
            submitProject(){
                ...
                createProjectCat(this.projectForm).then(res=>{
                    this.$message({
                        type:'success',
                        message:'添加成功'
                    }).catch(err=>{
